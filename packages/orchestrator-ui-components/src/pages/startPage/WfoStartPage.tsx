...
export const WfoStartPage = () => {
  ...
  const defaultSummaryCards: ReactElement[] = [
    ...toOptionalArrayEntry(<WfoMyWorkflowsSummaryCard key="myWorkflows" username={username} />, !!username),
  ...
  return (
    <>
      <WfoContentHeader title={<EuiPageHeader pageTitle={`${t('welcome')} ${username}`} />} />
