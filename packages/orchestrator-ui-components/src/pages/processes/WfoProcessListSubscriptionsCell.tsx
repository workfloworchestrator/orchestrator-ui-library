...
export const WfoProcessListSubscriptionsCell: FC<WfoProcessesListSubscriptionsCellProps> = ({
  subscriptions,
  ...
  const visibleSubscriptions =
    numberOfSubscriptionsToRender === RENDER_ALL ? subscriptions : (
  ...
  return (
    <>
      <EuiFlexGroup
        direction={renderDirection === RenderDirection.HORIZONTAL ? 'row' : 'column'}
        gutterSize={renderDirection === RenderDirection.HORIZONTAL ? 's' : 'xs'}
      >
