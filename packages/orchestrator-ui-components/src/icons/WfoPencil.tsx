...
export const WfoPencil: FC<WfoIconProps> = ({ width = 24, height = 24, color = '#000000' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="0 0 24 24">
    <Path color={color} />
  </svg>
);

export const WfoPencilCompact: FC<WfoIconProps> = ({ width = 24, height = 24, color = '#000000' }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={width} height={height} viewBox="5 5 14 14">
    <Path color={color} />
  </svg>
);
