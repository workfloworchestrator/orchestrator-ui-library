...
const WfoSquareStack3dStackSvg: FC<WfoIconProps> = ({ width = 20, height = 20, color = 'currentColor' }) => (
...
export const WfoSquareStack3dStack = withWfoHeroIconsWrapper(WfoSquareStack3dStackSvg);
