...
const WfoArrowsUpDownSvg: FC<WfoIconProps> = ({ width = 20, height = 20, color = 'currentColor' }) => (
  <svg width={width} height={height} viewBox="2 2 20 20" fill={color} xmlns="http://www.w3.org/2000/svg">
    <path
      fillRule="evenodd"
