...
const IPPrefixTable = ({
    ...
    console.log(id, name, onChange, onManualOverride, selected_prefix_id);
    return <div>TODO: Re-include ipprefix table</div>;
};

interface SplitPrefixProps {
    id: string;
    name: string;
    subnet: string;
    prefixlen: number;
...
const SplitPrefix = ({
    ...
    return <div>TODO: Re-include SplitPrefix</div>;
};
