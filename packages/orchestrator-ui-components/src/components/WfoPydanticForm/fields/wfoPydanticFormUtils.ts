...
export type SummaryFormLabel = string | null | undefined | Record<string, unknown>;

export const getNestedSummaryLabel = (labels: SummaryFormLabel[], index: number): string => {
