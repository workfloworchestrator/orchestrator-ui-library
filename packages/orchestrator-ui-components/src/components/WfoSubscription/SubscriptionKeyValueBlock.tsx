...
import { WfoKeyValueTable, WfoKeyValueTableDataType } from '../WfoKeyValueTable/WfoKeyValueTable';
...
export const SubscriptionKeyValueBlock = ({ title, keyValues }: SubscriptionKeyValueBlockProps) => {
