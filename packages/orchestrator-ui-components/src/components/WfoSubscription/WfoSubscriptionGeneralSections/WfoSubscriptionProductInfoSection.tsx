...
export const WfoSubscriptionProductInfoSection = ({ product }: WfoSubscriptionProductInfoSectionProps) => {
  ...
  return <SubscriptionKeyValueBlock title={t('blockTitleProductInfo')} keyValues={productInfoBlockData} />;
};
