...
import { WfoError, WfoFirstPartUUID, WfoKeyValueTable, WfoLoading } from '@/components';
...
export const WfoInUseByRelations = ({ inUseByRelations }: WfoInUseByRelationsProps) => {
  ...
  const getKeyValues = (inUseByRelationDetails: InUseByRelationDetail): WfoKeyValueTableDataType[] => {
    return [
      {
        key: t('subscriptionId'),
        value: <WfoFirstPartUUID UUID={inUseByRelationDetails.subscriptionId} showCopyIcon={false} />,
