...
export const getSubscriptionDetailStyles = ({ theme, isDarkModeActive }: WfoThemeHelpers) => {
  ...
  const tableStyle = css({
    backgroundColor: isDarkModeActive ? theme.colors.backgroundBasePlain : theme.colors.backgroundBaseSubdued,
    width: '100%',
