...
import { determineNewSortOrder, determinePageIndex, getPageCount, hasSpecialCharacterOrSpace } from './tableUtils';
...
describe('tableUtils', () => {
  ...
  describe('determineNewSortOrder', () => {
    ...
    it('returns SortDirection.Asc when sorting on a new column', () => {
      ...
      const result = determineNewSortOrder<TestData>(currentSortColumnId, currentSortDirection, newSortColumnId);
