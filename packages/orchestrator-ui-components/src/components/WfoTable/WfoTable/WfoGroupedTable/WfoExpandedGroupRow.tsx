...
import { WfoGroupedTableGroups, WfoGroupedTableGroupsProps, WfoGroupedTableGroupsRef } from './WfoGroupedTableGroups';
...
export const WfoExpandedGroupRow = React.forwardRef(
  <T extends object>(
    { data, columnConfig, nestingLevel = 1, groupNameLabel, onExpandRowChange }: WfoExpandedGroupRowProps<T>,
    ...
    if (Array.isArray(data)) {
      return (
        <>
          <WfoTableHeaderRow css={[innerTableHeaderStyle, getNestingStyle(nestingLevel)]} columnConfig={columnConfig} />
          <WfoTableDataRows
