...
export const WfoTableHeaderRow = <T extends object>({
  ...
  const { cellStyle, headerCellContainer, sortableHeaderCellStyle, rowStyle, setWidth } =
  ...
  return (
    <tr className={className} css={rowStyle} ref={headerRowRef}>
      {sortedVisibleColumns.map(([fieldName, columnConfig], index) => {
        const dataSortingConfiguration = dataSorting.find((dataSorting) => dataSorting.field === fieldName);
          ...
          return (
            <th
              ...
              css={[
                ...
                ...toOptionalArrayEntry(sortableHeaderCellStyle, !!columnConfig.isSortable),
            ...
            >
              <div css={headerCellContainer}>
                ...
                {typeof onUpdateColumWidth === 'function' && index !== sortedVisibleColumns.length - 1 && (
                  <WfoDragHandler
