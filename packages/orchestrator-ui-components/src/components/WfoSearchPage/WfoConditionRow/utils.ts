...
export const shouldHideValueInput = (selectedPathInfo: PathInfo | null, operatorSelected: boolean): boolean => {
...
export const isFullPathSelected = (path: string, selectedPathInfo: PathInfo | null): boolean => {
  return !!(
    path
    && (path.includes('.')
...
export const getFieldNameFromPath = (path: string, isComponent: boolean): string => {
...
export const getPathSelectionOptions = (selectedFieldName: string, paths: PathInfo[]) => {
