...
export const WfoSearch = () => {
  ...
  const { currentPage, error, isLoadingMore, handleNextPage, handlePrevPage, resetPagination, setError } =
    useSearchPagination(debouncedQuery, selectedEntityTab, filterGroup, pageSize, results, setResults, retrieverType);
      ...
      {showFilters && (
        <>
          ...
          <EuiPanel hasBorder paddingSize="m">
            ...
            <EuiSpacer size="s" />
            <FilterGroup group={filterGroup} entityType={selectedEntityTab} onChange={setFilterGroup} isRoot />
          </EuiPanel>
        </>
      )}
        ...
        <>
          ...
          <EuiFlexGroup gutterSize="s" alignItems="center">
            <EuiFlexItem grow={showDetailPanel ? RESULTS_GROW : 1}>
              ...
              >
                <EuiFlexItem grow={false}>
                  <WfoSearchMetadataHeader search_metadata={results.search_metadata} />
                </EuiFlexItem>
          ...
          <EuiFlexGroup gutterSize="s" alignItems="flexStart">
            ...
            {showDetailPanel && (
              <EuiFlexItem grow={DETAIL_GROW}>
                <EuiPanel paddingSize="m" hasBorder={true} hasShadow={false} color="transparent">
