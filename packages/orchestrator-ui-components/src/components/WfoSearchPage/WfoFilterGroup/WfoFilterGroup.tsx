...
export const FilterGroup: FC<FilterGroupProps> = ({
  ...
  return (
    <EuiPanel paddingSize="m" color={depth % 2 === 0 ? 'primary' : 'plain'} hasBorder>
      <EuiFlexGroup gutterSize="s" alignItems="center" justifyContent="spaceBetween">
        <EuiFlexItem grow={false}>
          <EuiFlexGroup gutterSize="s" alignItems="center">
            ...
            <EuiFlexItem grow={false}>
              <EuiButton size="s" fill={true} color="primary" onClick={toggleOperator}>
                {group.op}
              </EuiButton>
            </EuiFlexItem>
          </EuiFlexGroup>
        ...
        <EuiFlexItem grow={false}>
          <EuiFlexGroup gutterSize="s" alignItems="center">
            ...
            <EuiFlexItem grow={false}>
              <WfoToolTip tooltipContent={!canAddGroup ? t('maxNestingDepth') : t('addNestedGroup')}>
                <EuiButton size="s" iconType="nested" onClick={addGroup} disabled={!canAddGroup}>
                  {t('addGroup')}
                </EuiButton>
              </WfoToolTip>
            </EuiFlexItem>
            {!isRoot && onRemove && (
              <EuiFlexItem grow={false}>
                <EuiButtonIcon iconType="trash" color="danger" onClick={onRemove} aria-label={t('removeGroup')} />
              </EuiFlexItem>
            )}
          </EuiFlexGroup>
        </EuiFlexItem>
              ...
              <div key={index}>
                {index > 0 && (
                  <EuiFlexGroup gutterSize="none" alignItems="center" justifyContent="center">
                    <EuiFlexItem grow={false}>
                      <EuiText size="s" color={theme.colors.textSubdued} textAlign="center">
