...
import { EuiButtonIcon, EuiFlexGroup, EuiFlexItem, EuiPanel, EuiSpacer, EuiText } from '@elastic/eui';
      ...
      >
        <EuiFlexGroup alignItems="flexStart" gutterSize="m">
          ...
          <EuiFlexItem grow={false}>
            <EuiFlexGroup direction="column" alignItems="flexEnd" gutterSize="xs">
              <EuiFlexItem>
                <WfoBadge color={theme.colors.primary} textColor={theme.colors.textGhost}>
                  {'score' in result && result.score ? result.score.toFixed(4) : 'N/A'}
                </WfoBadge>
              </EuiFlexItem>
              <EuiFlexItem>
                <EuiButtonIcon
