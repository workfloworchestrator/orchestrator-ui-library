...
export type ProductBlockInstanceForDropdown = Omit<ProductBlockInstance, 'inUseByRelations'>;
...
export type InUseByRelationDetail = Pick<Subscription, 'subscriptionId' | 'description'> & {
  product: Pick<ProductDefinition, 'name'>;
};
