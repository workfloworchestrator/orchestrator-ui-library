...
export type ConfirmDialogHandler = (
  e: React.KeyboardEvent<HTMLDivElement> | React.MouseEvent<HTMLButtonElement, MouseEvent> | undefined,
) => void;
...
export function ConfirmationDialogContextWrapper({ children }: { children: ReactNode }) {
  const [confirmationDialogOpen, setConfirmationDialogOpen] = useState(false);
  const [{ onConfirm, question, isError, subQuestion, cancelButtonText, confirmButtonText }, setState] =
