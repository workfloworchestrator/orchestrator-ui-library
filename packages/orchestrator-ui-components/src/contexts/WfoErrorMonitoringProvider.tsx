...
export const WfoErrorMonitoringContext = createContext<WfoErrorMonitoring>(emptyWfoErrorMonitoring);
 ...
 * @param children
 */
export const WfoErrorMonitoringProvider: FC<WfoErrorMonitoringProviderProps> = ({
  errorMonitoringHandler,
  children,
}) => {
  return (
    <WfoErrorMonitoringContext.Provider value={errorMonitoringHandler ?? emptyWfoErrorMonitoring}>
      {children}
