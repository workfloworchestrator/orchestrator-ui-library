...
export const SUBSCRIPTION_DROPDOWN_OPTIONS_ENDPOINT = 'surf/subscriptions/dropdown-options';
export const CUSTOMER_DESCRIPTION_ENDPOINT = '/subscription_customer_descriptions';
