...
import { Locale, useGetTranslationMessages } from '@orchestrator-ui/orchestrator-ui-components';
...
export const TranslationsProvider = ({ children }: TranslationsProviderProps) => {
  ...
  return (
    <IntlProvider locale={locale || Locale.enGB} messages={messages} onError={onError}>
      {children}
    </IntlProvider>
  );
};
